...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'KingHu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Linux运维工程师,会点MySQL/MongoDB/Redis/Python/shell', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kingkingho.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Linux,MySQL,MongoDB,Redis,Python,shell', // 网站关键词 英文逗号隔开
